...
// api/decks.ts
var onRequestGet2, onRequestPost2, onRequestDelete;
...
// api/games.ts
var onRequestGet3, onRequestPost3, onRequestDelete2;
...
var init_web = __esm({
  "../node_modules/@google/genai/dist/web/index.mjs"() {
    ...
    APIError = class extends GeminiNextGenAPIClientError {
...
${underline}`);
    ...
    __name(BaseInteractions, "BaseInteractions");
    ...
    BaseGeminiNextGenAPIClient = class {
      /**
    ...
    __name(BaseGeminiNextGenAPIClient, "BaseGeminiNextGenAPIClient");
    ...
    __name(GeminiNextGenAPIClient, "GeminiNextGenAPIClient");
...
async function onRequest(context) {
  ...
  try {
    ...
    const getStylePrompt = /* @__PURE__ */ __name((style) => {
      switch (style) {
        case "FANTASY_OIL":
...
// ../.wrangler/tmp/bundle-5DF7qh/middleware-loader.entry.ts
init_functionsRoutes_0_805278482237037();
init_checked_fetch();
init_strip_cf_connecting_ip_header();

// ../.wrangler/tmp/bundle-5DF7qh/middleware-insertion-facade.js
init_functionsRoutes_0_805278482237037();
init_checked_fetch();
init_strip_cf_connecting_ip_header();
...
@google/genai/dist/web/index.mjs:
   ...
   *)
*/
//# sourceMappingURL=functionsWorker-0.45495661337433624.mjs.map
