...
// .wrangler/tmp/bundle-pRyepM/checked-fetch.js
...
// .wrangler/tmp/bundle-pRyepM/strip-cf-connecting-ip-header.js
...
// .wrangler/tmp/pages-3ojb7O/functionsWorker-0.45495661337433624.mjs
...
var init_checked_fetch = __esm({
  "../.wrangler/tmp/bundle-5DF7qh/checked-fetch.js"() {
...
var init_strip_cf_connecting_ip_header = __esm({
  "../.wrangler/tmp/bundle-5DF7qh/strip-cf-connecting-ip-header.js"() {
...
var init_cards = __esm({
  "api/cards.ts"() {
    init_functionsRoutes_0_805278482237037();
    init_checked_fetch();
    ...
    onRequestPost = /* @__PURE__ */ __name2(async (context) => {
      try {
        const card = await context.request.json();
...
var init_decks = __esm({
  "api/decks.ts"() {
    ...
    onRequestPost2 = /* @__PURE__ */ __name2(async (context) => {
      try {
        const deck = await context.request.json();
        const existing = await context.env.DB.prepare("SELECT id FROM decks WHERE id = ?").bind(deck.id).first();
        if (existing) {
          await context.env.DB.prepare("UPDATE decks SET name=?, cardIds=? WHERE id=?").bind(deck.name, JSON.stringify(deck.cardIds), deck.id).run();
        } else {
          await context.env.DB.prepare("INSERT INTO decks (id, gameId, name, cardIds) VALUES (?, ?, ?, ?)").bind(deck.id, deck.gameId, deck.name, JSON.stringify(deck.cardIds)).run();
        }
  ...
  "api/games.ts"() {
    ...
    onRequestGet3 = /* @__PURE__ */ __name2(async (context) => {
      try {
        ...
        const parsed = results.map((g) => ({
          ...g,
          rules: g.rules ? JSON.parse(g.rules) : void 0
        }));
        return new Response(JSON.stringify(parsed), { headers: { "Content-Type": "application/json" } });
      } catch (e) {
        return new Response(JSON.stringify({ error: e.message }), { status: 500 });
...
var require_p_retry = __commonJS({
  "../node_modules/p-retry/index.js"(exports, module) {
    ...
    var AbortError2 = /* @__PURE__ */ __name(class extends Error {
      constructor(message) {
        super();
    ...
    __name2(AbortError2, "AbortError");
...
var init_web = __esm({
  "../node_modules/@google/genai/dist/web/index.mjs"() {
    ...
    BaseModule = /* @__PURE__ */ __name(class {
    }, "BaseModule");
    __name2(BaseModule, "BaseModule");
    ...
    HttpResponse = /* @__PURE__ */ __name(class {
    ...
    __name2(HttpResponse, "HttpResponse");
    GenerateContentResponse = /* @__PURE__ */ __name(class {
      /**
    ...
    __name2(GenerateContentResponse, "GenerateContentResponse");
    EmbedContentResponse = /* @__PURE__ */ __name(class {
    }, "EmbedContentResponse");
    __name2(EmbedContentResponse, "EmbedContentResponse");
    GenerateImagesResponse = /* @__PURE__ */ __name(class {
    }, "GenerateImagesResponse");
    __name2(GenerateImagesResponse, "GenerateImagesResponse");
    EditImageResponse = /* @__PURE__ */ __name(class {
    }, "EditImageResponse");
    __name2(EditImageResponse, "EditImageResponse");
    UpscaleImageResponse = /* @__PURE__ */ __name(class {
    }, "UpscaleImageResponse");
    __name2(UpscaleImageResponse, "UpscaleImageResponse");
    RecontextImageResponse = /* @__PURE__ */ __name(class {
    }, "RecontextImageResponse");
    __name2(RecontextImageResponse, "RecontextImageResponse");
    SegmentImageResponse = /* @__PURE__ */ __name(class {
    }, "SegmentImageResponse");
    __name2(SegmentImageResponse, "SegmentImageResponse");
    ListModelsResponse = /* @__PURE__ */ __name(class {
    }, "ListModelsResponse");
    __name2(ListModelsResponse, "ListModelsResponse");
    DeleteModelResponse = /* @__PURE__ */ __name(class {
    }, "DeleteModelResponse");
    __name2(DeleteModelResponse, "DeleteModelResponse");
    CountTokensResponse = /* @__PURE__ */ __name(class {
    }, "CountTokensResponse");
    __name2(CountTokensResponse, "CountTokensResponse");
    ComputeTokensResponse = /* @__PURE__ */ __name(class {
    }, "ComputeTokensResponse");
    __name2(ComputeTokensResponse, "ComputeTokensResponse");
    GenerateVideosOperation = /* @__PURE__ */ __name(class {
      /**
    ...
    __name2(GenerateVideosOperation, "GenerateVideosOperation");
    ListTuningJobsResponse = /* @__PURE__ */ __name(class {
    }, "ListTuningJobsResponse");
    __name2(ListTuningJobsResponse, "ListTuningJobsResponse");
    CancelTuningJobResponse = /* @__PURE__ */ __name(class {
    }, "CancelTuningJobResponse");
    __name2(CancelTuningJobResponse, "CancelTuningJobResponse");
    DeleteCachedContentResponse = /* @__PURE__ */ __name(class {
    }, "DeleteCachedContentResponse");
    __name2(DeleteCachedContentResponse, "DeleteCachedContentResponse");
    ListCachedContentsResponse = /* @__PURE__ */ __name(class {
    }, "ListCachedContentsResponse");
    __name2(ListCachedContentsResponse, "ListCachedContentsResponse");
    ListDocumentsResponse = /* @__PURE__ */ __name(class {
    }, "ListDocumentsResponse");
    __name2(ListDocumentsResponse, "ListDocumentsResponse");
    ListFileSearchStoresResponse = /* @__PURE__ */ __name(class {
    }, "ListFileSearchStoresResponse");
    __name2(ListFileSearchStoresResponse, "ListFileSearchStoresResponse");
    UploadToFileSearchStoreResumableResponse = /* @__PURE__ */ __name(class {
    }, "UploadToFileSearchStoreResumableResponse");
    __name2(UploadToFileSearchStoreResumableResponse, "UploadToFileSearchStoreResumableResponse");
    ImportFileOperation = /* @__PURE__ */ __name(class {
      /**
       * Instantiates an Operation of the same type as the one being called with the fields set from the API response.
       * @internal
       */
    ...
    __name2(ImportFileOperation, "ImportFileOperation");
    ListFilesResponse = /* @__PURE__ */ __name(class {
    }, "ListFilesResponse");
    __name2(ListFilesResponse, "ListFilesResponse");
    CreateFileResponse = /* @__PURE__ */ __name(class {
    }, "CreateFileResponse");
    __name2(CreateFileResponse, "CreateFileResponse");
    DeleteFileResponse = /* @__PURE__ */ __name(class {
    }, "DeleteFileResponse");
    __name2(DeleteFileResponse, "DeleteFileResponse");
    RegisterFilesResponse = /* @__PURE__ */ __name(class {
    }, "RegisterFilesResponse");
    __name2(RegisterFilesResponse, "RegisterFilesResponse");
    ListBatchJobsResponse = /* @__PURE__ */ __name(class {
    }, "ListBatchJobsResponse");
    __name2(ListBatchJobsResponse, "ListBatchJobsResponse");
    LiveServerMessage = /* @__PURE__ */ __name(class {
      /**
    ...
    __name2(LiveServerMessage, "LiveServerMessage");
    LiveMusicServerMessage = /* @__PURE__ */ __name(class {
      /**
    ...
    __name2(LiveMusicServerMessage, "LiveMusicServerMessage");
    UploadToFileSearchStoreOperation = /* @__PURE__ */ __name(class {
      /**
       * Instantiates an Operation of the same type as the one being called with the fields set from the API response.
       * @internal
       */
    ...
    __name2(UploadToFileSearchStoreOperation, "UploadToFileSearchStoreOperation");
    ...
    __name2(Pager, "Pager");
    Batches = /* @__PURE__ */ __name(class extends BaseModule {
    ...
    Caches = /* @__PURE__ */ __name(class extends BaseModule {
      constructor(apiClient) {
        super();
        this.apiClient = apiClient;
        this.list = async (params = {}) => {
    ...
    __name2(Chat, "Chat");
    ApiError = /* @__PURE__ */ __name(class extends Error {
      constructor(options) {
    ...
    Files = /* @__PURE__ */ __name(class extends BaseModule {
      constructor(apiClient) {
        super();
        this.apiClient = apiClient;
        this.list = async (params = {}) => {
    ...
    McpCallableTool = /* @__PURE__ */ __name(class {
    ...
    __name2(McpCallableTool, "McpCallableTool");
    __name2(handleWebSocketMessage$1, "handleWebSocketMessage$1");
    LiveMusic = /* @__PURE__ */ __name(class {
    ...
    __name2(LiveMusic, "LiveMusic");
    LiveMusicSession = /* @__PURE__ */ __name(class {
    ...
    __name2(LiveMusicSession, "LiveMusicSession");
    ...
    Models = /* @__PURE__ */ __name(class extends BaseModule {
      constructor(apiClient) {
        super();
        this.apiClient = apiClient;
    ...
    Operations = /* @__PURE__ */ __name(class extends BaseModule {
      constructor(apiClient) {
        super();
        this.apiClient = apiClient;
      }
    ...
    Tokens = /* @__PURE__ */ __name(class extends BaseModule {
      constructor(apiClient) {
        super();
        this.apiClient = apiClient;
      }
    ...
    Documents = /* @__PURE__ */ __name(class extends BaseModule {
      constructor(apiClient) {
        super();
        this.apiClient = apiClient;
        this.list = async (params) => {
    ...
    __name2(Documents, "Documents");
    FileSearchStores = /* @__PURE__ */ __name(class extends BaseModule {
    ...
    __name2(FileSearchStores, "FileSearchStores");
    ...
    GeminiNextGenAPIClientError = /* @__PURE__ */ __name(class extends Error {
    }, "GeminiNextGenAPIClientError");
    __name2(GeminiNextGenAPIClientError, "GeminiNextGenAPIClientError");
    APIError = /* @__PURE__ */ __name(class extends GeminiNextGenAPIClientError {
...
${underline}`);
    ...
    BaseInteractions = /* @__PURE__ */ __name(class extends APIResource {
    ...
    __name2(BaseInteractions, "BaseInteractions");
    BaseInteractions._key = Object.freeze(["interactions"]);
    Interactions = /* @__PURE__ */ __name(class extends BaseInteractions {
    }, "Interactions");
    __name2(Interactions, "Interactions");
    ...
    BaseGeminiNextGenAPIClient = /* @__PURE__ */ __name(class {
      /**
    ...
    __name2(BaseGeminiNextGenAPIClient, "BaseGeminiNextGenAPIClient");
    BaseGeminiNextGenAPIClient.DEFAULT_TIMEOUT = 6e4;
    GeminiNextGenAPIClient = /* @__PURE__ */ __name(class extends BaseGeminiNextGenAPIClient {
      constructor() {
        super(...arguments);
        this.interactions = new Interactions(this);
      }
    }, "GeminiNextGenAPIClient");
    __name2(GeminiNextGenAPIClient, "GeminiNextGenAPIClient");
    ...
    Tunings = /* @__PURE__ */ __name(class extends BaseModule {
      constructor(apiClient) {
        super();
        this.apiClient = apiClient;
        this.list = async (params = {}) => {
    ...
    __name2(Tunings, "Tunings");
    BrowserDownloader = /* @__PURE__ */ __name(class {
      async download(_params, _apiClient) {
        throw new Error("Download to file is not supported in the browser, please use a browser compliant download like an <a> tag.");
      }
    }, "BrowserDownloader");
    __name2(BrowserDownloader, "BrowserDownloader");
    ...
    __name2(sleep, "sleep");
    BrowserUploader = /* @__PURE__ */ __name(class {
    ...
    __name2(BrowserUploader, "BrowserUploader");
    BrowserWebSocketFactory = /* @__PURE__ */ __name(class {
      create(url, headers, callbacks) {
        return new BrowserWebSocket(url, headers, callbacks);
      }
    }, "BrowserWebSocketFactory");
    __name2(BrowserWebSocketFactory, "BrowserWebSocketFactory");
    BrowserWebSocket = /* @__PURE__ */ __name(class {
    ...
    __name2(BrowserWebSocket, "BrowserWebSocket");
    GOOGLE_API_KEY_HEADER = "x-goog-api-key";
    WebAuth = /* @__PURE__ */ __name(class {
      constructor(apiKey) {
        this.apiKey = apiKey;
      }
    ...
    __name2(WebAuth, "WebAuth");
    LANGUAGE_LABEL_PREFIX = "gl-node/";
    GoogleGenAI = /* @__PURE__ */ __name(class {
      get interactions() {
        var _a2;
    ...
    __name2(GoogleGenAI, "GoogleGenAI");
  }
});
async function onRequest(context) {
  ...
  try {
    ...
    const getStylePrompt = /* @__PURE__ */ __name2((style) => {
      switch (style) {
        case "FANTASY_OIL":
          return "Oil painting style, classical fantasy, highly detailed, dramatic lighting, Magic the Gathering style";
        case "CYBERPUNK":
          return "Cyberpunk 2077 style, neon lights, high tech, low life, futuristic, digital art, glitch effects";
        case "PIXEL_ART":
          return "16-bit pixel art, retro game style, vibrant colors, clean lines";
        case "ANIME":
          return "Anime style, cell shaded, Studio Ghibli inspired, expressive, vibrant";
        case "LOVECRAFT":
          return "Eldritch horror style, dark, gloomy, sketching, etching style, mysterious";
        case "MINIMALIST":
          return "Vector art, flat design, minimalist, clean, bold shapes, tarot card style";
        default:
          return "Digital art, high quality";
      }
    }, "getStylePrompt");
...
var routes;
var init_functionsRoutes_0_805278482237037 = __esm({
  "../.wrangler/tmp/pages-3ojb7O/functionsRoutes-0.805278482237037.mjs"() {
    init_cards();
    init_cards();
    init_decks();
    init_decks();
...
// .wrangler/tmp/bundle-pRyepM/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-pRyepM/middleware-loader.entry.ts
...
@google/genai/dist/web/index.mjs:
   ...
   *)
*/
//# sourceMappingURL=functionsWorker-0.45495661337433624.js.map
