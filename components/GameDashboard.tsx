          ...
          <div className="p-6 pb-2">
            <div className="flex justify-between items-center mb-6">
                <div className="relative">
                    <h1 className="text-3xl font-black text-white tracking-tighter italic">CARD FORGE</h1>
                    <div className="h-1 w-8 bg-fuchsia-500 mt-1 rounded-full shadow-[0_0_10px_#d946ef]"></div>
                </div>
