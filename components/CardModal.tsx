...
export const CardModal: React.FC<CardModalProps> = ({ card, onClose }) => {
  ...
  return (
    <div 
        className="fixed inset-0 z-[100] flex flex-col items-center justify-center p-4 bg-black/90 backdrop-blur-xl animate-fadeIn cursor-pointer"
        onClick={onClose}
    >
        ...
        >
            ...
            <div className="transform transition-transform duration-300 hover:scale-105">
                <CardComponent card={card} scale={1.1} />
            </div>
